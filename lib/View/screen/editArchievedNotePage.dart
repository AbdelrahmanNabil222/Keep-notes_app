...
class EditArchievedNotePage extends StatelessWidget {
  EditArchievedNotePage({
    super.key,
    required this.docid,
  ...
  Widget build(BuildContext context) {
    final EditArchievedNoteController controller = Get.find();
